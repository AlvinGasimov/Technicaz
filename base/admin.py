...
class NavigationItemAdmin(TranslationAdmin):
    list_display = ('title', 'phone_number', 'email', 'address',)
...
class HomeAdmin(TranslationAdmin):
    list_display = ('title', 'main_img', 'responsive_img')
...
class PromotionAdmin(TranslationAdmin):
    list_display = ('title', 'image', 'video_link')
    group_fieldsets = True
    class Media:
        js = (
            'http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',
...
class QuestionAnswerAdmin(TranslationAdmin):
